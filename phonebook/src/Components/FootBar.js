...
const FootBar = () => {
    ...
    return (
        <div className="h-10 w-full flex items-center justify-center p-8 border-t border-gray-300 border-opacity-20 " style={{ position: "sticky", bottom: "0", backgroundColor: "black" }}>
            ...
            <div className="flex flex-col items-center justify-center mx-5 " onClick={() => handleClick(0)}>
            ...
            <div className="flex flex-col items-center justify-center mx-5 " onClick={() => handleClick(1)}>
            ...
            <div className="flex flex-col items-center justify-center mx-5 " onClick={() => handleClick(2)}>
